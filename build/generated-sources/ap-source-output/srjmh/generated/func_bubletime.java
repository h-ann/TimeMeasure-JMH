...
import srjmh.generated.func_jmh;
@Generated("org.openjdk.jmh.generators.core.BenchmarkGenerator")
public final class func_bubletime {
    ...
    public Collection<ThroughputResult> bubletime_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            func_jmh l_func0_0 = _jmh_tryInit_f_func0_0(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_func0_0.bubletime());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            bubletime_thrpt_jmhStub(control, res, l_func0_0, l_blackhole1_1);
            ...
            if (control.isLastIteration()) {
                if (l_func0_0.readyTrial) {
                    l_func0_0.readyTrial = false;
                }
                f_func0_0 = null;
                f_blackhole1_1 = null;
            }
            Collection<ThroughputResult> results = new ArrayList<ThroughputResult>();
            results.add(new ThroughputResult(ResultRole.PRIMARY, "bubletime", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void bubletime_thrpt_jmhStub(InfraControl control, RawResults result, func_jmh l_func0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<AverageTimeResult> bubletime_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            func_jmh l_func0_0 = _jmh_tryInit_f_func0_0(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            bubletime_avgt_jmhStub(control, res, l_func0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "bubletime", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void bubletime_avgt_jmhStub(InfraControl control, RawResults result, func_jmh l_func0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<SampleTimeResult> bubletime_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            func_jmh l_func0_0 = _jmh_tryInit_f_func0_0(control, threadParams);
            ...
            bubletime_sample_jmhStub(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_func0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_func0_0.bubletime());
            ...
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "bubletime", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void bubletime_sample_jmhStub(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, func_jmh l_func0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<SingleShotResult> bubletime_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            func_jmh l_func0_0 = _jmh_tryInit_f_func0_0(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            int batchSize = control.iterationParams.getBatchSize();
            bubletime_ss_jmhStub(control, batchSize, res, l_func0_0, l_blackhole1_1);
            control.preTearDown();
            if (l_blackhole1_1.readyIteration) {
                l_blackhole1_1.readyIteration = false;
            }
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "bubletime", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void bubletime_ss_jmhStub(InfraControl control, int batchSize, RawResults result, func_jmh l_func0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    func_jmh _jmh_tryInit_f_func0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (f_func0_0 == null) {
            func_jmh val = new func_jmh();
                Field f;
            f = srjmh.func.class.getDeclaredField("len");
